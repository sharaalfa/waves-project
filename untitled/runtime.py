...
clean_train_reviews = []
for row in X_train:
    clean_train_reviews.append(" ".join(cleaner.review_to_wordlist(row)))
...
dump(vectorizer, '/home/sharhack/Загрузки/waves/vectorizer.joblib')
dump(forest, '/home/sharhack/Загрузки/waves/forest.joblib')
dump(X_test, '/home/sharhack/Загрузки/waves/X_test.joblib')
